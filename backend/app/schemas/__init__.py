...
Consolidated from the previous single-file `app/schemas.py` so that
...
from ..models import RoleEnum as ModelRoleEnum, IncidentTypeEnum as ModelIncidentTypeEnum, SeverityEnum as ModelSeverityEnum
